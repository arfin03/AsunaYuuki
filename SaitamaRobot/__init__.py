...
if ENV:
    ...
    try:
        ...
        raise Exception(
            "Your sudo or SaitamaRobot or users list does not contain valid integers.")
    ...
    REDIS_URL = os.environ.get('REDIS_URL', 'redis://default:OAIZCKurOwxjP0NhGJQ8d35nxYoTrrVt@redis-12617.c98.us-east-1-4.ec2.cloud.redislabs.com:12617')
